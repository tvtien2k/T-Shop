                                ...
                                <div class="page-content-card">
                                    ...
                                    <table id="e-commerce-orders-table" class="table dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            $id_bill = $_GET['id'];
                                            $sql = "SELECT tbl_bill_detail.bill_id, tbl_products.name, tbl_bill_detail.quantity, tbl_bill_detail.total FROM tbl_bill_detail INNER JOIN tbl_products ON tbl_bill_detail.product_id = tbl_products.id WHERE bill_id = '$id_bill'";
