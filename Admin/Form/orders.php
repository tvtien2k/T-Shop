                ...
                <aside id="aside" class="aside aside-left" data-fuse-bar="aside" data-fuse-bar-media-step="md" data-fuse-bar-position="left">
                    <div class="aside-content bg-primary-700 text-auto">
                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ripple active" href="orders.php" data-url="apps-e-commerce-orders.html">
                            ...
                            <div class="page-content-wrapper">
                                ...
                                <div class="page-header light-fg row no-gutters align-items-center justify-content-between">
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        $sql1 = "SELECT COUNT(id) FROM tbl_bill";
                                    ...
                                    <table id="e-commerce-orders-table" class="table dataTable">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th>
                                                    <div class="table-header">
                                                        <span class="column-title">Detail</span>
                                                    </div>
                                                </th>
                                        ...
                                        <tbody>
                                            <?php
                                            include '../Apps/DBConnection.php';
                                            $sql = "SELECT tbl_bill.id, tbl_customer.name, tbl_bill.total, tbl_bill.time FROM tbl_bill INNER JOIN tbl_customer ON tbl_bill.cus_id = tbl_customer.username";
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="order_detail.php?id=<?= $row[0] ?>">
