                    ...
                    <div class="aside-content bg-primary-700 text-auto">
                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item" role="tab" id="heading-errors">
                                ...
                                <ul id="collapse-errors" class='collapse show' role="tabpanel" aria-labelledby="heading-errors" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple active" href="addBrand.php" data-url="dataProduct.php">
                        ...
                        <div id="e-commerce-product" class="page-layout simple tabbed">
                            ...
                            <div class="page-content">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link btn active" id="basic-info-tab" data-toggle="tab" href="#basic-info-tab-pane" role="tab" aria-controls="basic-info-tab-pane" aria-expanded="true">Brand</a>
                                    </li>
                                        ...
                                        <div class="card p-6">
                                            ...
                                            if (isset($_GET['id'])) {
                                                ...
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ?>
                                                    <form action="../Apps/DBEditBrand.php" method="POST">
                                            ...
                                            <?php } else {
                                                ?>
                                                <form action="../Apps/DBAddBrand.php" method="POST">
