                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item" role="tab" id="heading-authentication">
                                ...
                                <ul id="collapse-authentication" class='collapse show' role="tabpanel" aria-labelledby="heading-authentication" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple active" href="setLogin.php" data-url="apps-e-commerce-orders.html">
                        ...
                        <div id="login-v2" class="row no-gutters">
                            ...
                            <div class="form-wrapper col-12 col-md-auto d-flex justify-content-center p-4 p-md-0">
                                ...
                                <div class="form-content md-elevation-8 h-100 bg-white text-auto py-16 py-md-32 px-12">
                                    ...
                                    <div class="title h5">Login to your account</div>

                                    <form name="loginForm" novalidate class="mt-8" action="../Apps/DBLogin.php" method="POST">

                                        <div class="form-group mb-4">
                                            <input type="email" class="form-control" id="loginFormInputEmail" aria-describedby="emailHelp" placeholder=" " name="txtUser"/>
                                        ...
                                        <div class="remember-forgot-password row no-gutters align-items-center justify-content-between pt-4"></div>
                                        <button type="submit" name="submit" class="submit-button btn btn-block btn-secondary my-4 mx-auto" aria-label="LOG IN">
                                            LOG IN
                                        </button>
