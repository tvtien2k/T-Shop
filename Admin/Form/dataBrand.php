                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item" role="tab" id="heading-errors">
                                ...
                                <ul id="collapse-errors" class='collapse show' role="tabpanel" aria-labelledby="heading-errors" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple active" href="dataBrand.php" data-url="dataProduct.php">
                            ...
                            <div class="page-content-wrapper">
                                ...
                                <div class="page-header light-fg row no-gutters align-items-center justify-content-between">
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        $sql1 = "SELECT COUNT(id) FROM tbl_brands";
                                    ...
                                    <div class="col-auto">
                                        <a href="addBrand.php" class="btn btn-light">ADD NEW BRAND</a>
                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>true</td>
                                                    <td>
                                                        <a href="../Apps/DBDeleteBrand.php?id=<?= $row[0] ?>">
                                                            <button type="button" class="btn btn-icon" aria-label="Product details">
