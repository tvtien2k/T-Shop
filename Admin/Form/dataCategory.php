                        ...
                        <ul class="nav flex-column custom-scrollbar" id="sidenav" data-children=".nav-item">
                            ...
                            <li class="nav-item" role="tab" id="heading-ecommerce">
                                ...
                                <ul id="collapse-ecommerce" class='collapse show' role="tabpanel" aria-labelledby="heading-ecommerce" data-children=".nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ripple active" href="dataCategory.php" data-url="index.html">
                            ...
                            <div class="page-content-wrapper">
                                ...
                                <div class="page-header light-fg row no-gutters align-items-center justify-content-between">
                                    ...
                                    <div class="col-12 col-sm">
                                        ...
                                        $sql1 = "SELECT COUNT(id) FROM tbl_categories";
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($result)) {
                                                ...
                                                <tr>
                                                    <td><?= $row[0] ?></td>
                                                    <td>
                                                        <a href="addCategory.php?id=<?= $row[0] ?>">
                                                    ...
                                                    <td>true</td>
                                                    <td>
                                                        <a href="../Apps/DBDeleteCategory.php?id=<?= $row[0] ?>">
                                                            <button type="button" class="btn btn-icon" aria-label="Product details">
